	...
	return (
		<div id="desktop-competition-item-none-running" style={{ backgroundImage: `url(${banner})` }} onClick={forwardToDetail}>
			<div className="desktop-competition-item__header">
				<div className="w-100">
					<div className={`desktop-competition-item__header__type ${typeCompetitionClassNames}`}>{upperCase(type)}</div>
				</div>
			</div>
			<div className="d-flex col-12">
				<div className="desktop-competition-item__content col-8">
					<div className="desktop-competition-item__content__info">
						...
						<div className="desktop-competition-item__content__info__currency">{toUpper(currency_id)}</div>
