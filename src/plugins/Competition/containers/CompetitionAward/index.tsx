...
export const CompetitionAward = (props: { competition_id: number }) => {
	...
	return (
		<React.Fragment>
			{awards.payload.length ? <div
				className={`competition-ranking-awards row mt-5  d-flex justify-content-center d-flex position-relative ${awards.loading ? backgroundLoadingClassName : ''
					}`}
			>
