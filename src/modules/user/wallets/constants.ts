...
export const WALLETS_WITHDRAW_CCY_PROCESS_FETCH = 'wallets/WITHDRAW_CCY_PROCESS_FETCH';
export const WALLETS_WITHDRAW_CCY_PROCESS_DATA = 'wallets/WITHDRAW_CCY_PROCESS_DATA';
...
export const WALLETS_WITHDRAW_LIMIT_FETCH = 'wallets/WITHDRAW_LIMIT_FETCH';
export const WALLETS_WITHDRAW_LIMIT_DATA = 'wallets/WITHDRAW_LIMIT_DATA';
export const WALLETS_WITHDRAW__LIMIT_ERROR = 'wallets/WITHDRAW_LIMIT_ERROR';
